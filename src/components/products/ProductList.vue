  ...
  <div class="row">
    <div class="d-flex">
      ...
      <div class="ms-1" v-if="productsStore.filter">
        for <spane class="fw-bold">
          {{ productsStore.filter.param }}
          {{ productsStore.filter.value }}
        </spane>
    ...
    <div class="d-flex justify-content-center">
      <button type="submit" class="btn btn-sm btn-dark mt-3" v-if="data.productsToShow < productsStore.products.length"
